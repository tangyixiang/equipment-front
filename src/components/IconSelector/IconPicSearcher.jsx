        ...
        >
          {modelLoaded || (
            <Spin
              ...
              tip={
                messages['app.docs.components.icon.pic-searcher.modelloading']
              }
            >
          ...
          {modelLoaded && (
            <Dragger
              ...
              listType="picture"
              customRequest={(o) => this.uploadFile(o.file)}
              fileList={fileList}
                  ...
                  <thead>
                    <tr>
                      <th className="col-icon">
                        {
                          messages[
                            'app.docs.components.icon.pic-searcher.th-icon'
                          ]
                        }
                      </th>
                      <th>
                        {
                          messages[
                            'app.docs.components.icon.pic-searcher.th-score'
                          ]
                        }
                      </th>
                    </tr>
